...
/* $('.burgerIcon').hover(function() {
    TweenMax.to('.burgerLine:first-child', 0.2, { rotation:40, y:20});
    TweenMax.to('.burgerLine:last-child', 0.2, { rotation: -40,transformOrigin:"left 50%",  y:8});
    TweenMax.to('.burgerLine:nth-child(2)', 0.2, { opacity: 0,});
},

function() {
    TweenMax.to('.burgerLine:first-child', 0.2, {rotation:0,  y:0});
    TweenMax.to('.burgerLine:last-child', 0.2, {rotation: 0,  y:0});
    TweenMax.to('.burgerLine:nth-child(2)', 0.2, { opacity: 1,});
}); */
